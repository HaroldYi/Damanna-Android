...
import com.hello.Damanna.activity.InviteMemberActivity;
import com.hello.Damanna.activity.MediaPlayerActivity;
import com.hello.Damanna.activity.MemberListActivity;
import com.hello.Damanna.activity.PhotoViewerActivity;
import com.hello.Damanna.adapter.GroupChatAdapter;
import com.hello.Damanna.common.FileUtils;
import com.hello.Damanna.common.PreferenceUtils;
import com.hello.Damanna.common.TextUtils;
import com.hello.Damanna.common.UrlPreviewInfo;
import com.hello.Damanna.common.WebUtils;
...
//                mIMM.hideSoftInputFromWindow(mMessageEditText.getWindowToken(), 0);
    ...
    private void updateActionBarTitle() {
        ...
        if (getActivity() != null) {
            ((ChatRoomActivity) getActivity()).setActionBarTitle(title);
        }
    }
