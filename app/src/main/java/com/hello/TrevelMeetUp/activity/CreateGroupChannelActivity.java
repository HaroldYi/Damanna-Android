...
import com.hello.TrevelMeetUp.common.PreferenceUtils;
import com.hello.TrevelMeetUp.fragment.SelectDistinctFragment;
import com.hello.TrevelMeetUp.fragment.SelectUserFragment;
...
public class CreateGroupChannelActivity extends AppCompatActivity
    ...
    public static final int STATE_SELECT_USERS = 0;
    public static final int STATE_SELECT_DISTINCT = 1;
